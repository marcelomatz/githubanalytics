...
const Header = () => {
  ...
  return (
    <div className="w-full justify-center bg-zinc-900 bg-background dark:bg-foreground py-8">
      ...
      <h1 className="text-2xl bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600"><Link href={"/"}>GitHub <span className="font-bold">Explorer</span></Link></h1>
